...
export default class Student extends Component {
  ...
  getStudents() {
    axios.get("http://localhost:8888/api/students").then((response) => {
  ...
  addStudent = () => {
    axios
      .post(
        "http://localhost:8888/api/create-student",
  ...
  updateStudent = () => {
    ...
    axios
      .post("http://localhost:8888/api/create-student", {
        first_name,
        last_name,
        email,
        phone,
  ...
  deletStudent = (id) => {
    ...
    axios
      .delete("http://localhost:8888/api/student/" + id)
      .then((response) => {
        this.setState({
          isLoading: false,
        });
